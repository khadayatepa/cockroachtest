...
st.markdown(f"### Question {idx+1}")st.write("Answer all questions and press **Submit**. After submission you'll see which answers were correct or wrong and your total score.") **Submit**. After submission you'll see which answers were correct or wrong and your total score.")
